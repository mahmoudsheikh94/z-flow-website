...
export const projects: Project[] = [
  // --- Software / Product Development ---
  {
    ...
    thumbnail: '/images/projects/prospectify/thumbnail.webp',
    screenshots: [],
    relatedSlugs: ['lead-generation-pipeline', 'layovr'],
    featured: true,
    status: 'live',
    testimonialId: 'prospectify',
  },
  {
    slug: 'layovr',
    category: 'software',
    ...
    screenshots: [],
    relatedSlugs: ['prospectify', 'volunteer-management'],
    featured: false,
    status: 'built',
  },
  {
    ...
    screenshots: [],
    relatedSlugs: ['layovr', 'prospectify'],
    featured: false,
    status: 'live',
  },
  ...
  // --- Process Digitalization ---
  {
    ...
    screenshots: [],
    relatedSlugs: ['prospectify', 'automated-invoicing'],
    featured: false,
    status: 'live',
  },
  {
